...
4. Features
A bullet-point list of key features
Examples:
Collision detection
Score tracking
Multiple levels
...
How to run the game file once downloaded (ex. "run 'py mygame.py'")
...
Describe what each person plans to contribute
